...
// #include <protobuf/BufferStream.h>
...
void ProtobufCodecLite::fillEmptyBuffer(common::net::Buffer* buf,
                                        const google::protobuf::Message& message)
{
...
int ProtobufCodecLite::serializeToBuffer(const google::protobuf::Message& message, Buffer* buf)
{
   ...
   * So, here, v3.9.2 is selected as maximum version using 'ByteSize()' to avoid potential effect for previous common code/projects as far as possible.
