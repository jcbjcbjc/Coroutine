...
#ifndef common_NET_PROTOBUF_PROTOBUFCODECLITE_H
#define common_NET_PROTOBUF_PROTOBUFCODECLITE_H
...
class ProtobufCodecLite : noncopyable
{
 public:
  ...
  void fillEmptyBuffer(common::net::Buffer* buf, const google::protobuf::Message& message);
...
class ProtobufCodecLiteT
{
 ...
 public:
  ...
  void onRpcMessage(const TcpConnectionPtr& conn,
                    ...
                    Timestamp receiveTime)
  {
    messageCallback_(conn, ::common::down_pointer_cast<MSG>(message), receiveTime);
  }

  void fillEmptyBuffer(common::net::Buffer* buf, const MSG& message)
  {
...
#endif  // common_NET_PROTOBUF_PROTOBUFCODECLITE_H
